...
init_phy()
{
	...
	update_register $((BASE_ADDR_WIZ0 + 0x00a0)) "h" "0x0252"
	
	# Enable APB
	# missing torrent_phy_probe

	echo "++ link_cmn_vals ++"
	update_register $((BASE_ADDR_WIZ0 + 0xc01c)) "h" "0x0003"

	update_register $((BASE_ADDR_WIZ0 + 0x0342)) "h" "0x0601" 
	update_register $((BASE_ADDR_WIZ0 + 0x0362)) "h" "0x0400" 
	update_register $((BASE_ADDR_WIZ0 + 0x0382)) "h" "0x8600" 
	
	echo "++ xcvr_diag_vals ++"
	update_register $((BASE_ADDR_WIZ0 + 0x41cc)) "h" "0x0000" 
	update_register $((BASE_ADDR_WIZ0 + 0x41ce)) "h" "0x0001" 
	update_register $((BASE_ADDR_WIZ0 + 0x41ca)) "h" "0x0012" 
	update_register $((BASE_ADDR_WIZ0 + 0x45cc)) "h" "0x0000" 
	update_register $((BASE_ADDR_WIZ0 + 0x45ce)) "h" "0x0001" 
	update_register $((BASE_ADDR_WIZ0 + 0x45ca)) "h" "0x0012" 

	echo "++ cmn_vals ++"
	update_register $((BASE_ADDR_WIZ0 + 0x0388)) "h" "0x0028"
	update_register $((BASE_ADDR_WIZ0 + 0x01aa)) "h" "0x001e"
	update_register $((BASE_ADDR_WIZ0 + 0x01ac)) "h" "0x000c"

	echo "++ rx_ln_vals ++"
	update_register $((BASE_ADDR_WIZ0 + 0x82e2)) "h" "0x0019"
	update_register $((BASE_ADDR_WIZ0 + 0x82e4)) "h" "0x0019"
	update_register $((BASE_ADDR_WIZ0 + 0x83fe)) "h" "0x0001" 
	update_register $((BASE_ADDR_WIZ0 + 0x86e2)) "h" "0x0019"
	update_register $((BASE_ADDR_WIZ0 + 0x86e4)) "h" "0x0019"
	update_register $((BASE_ADDR_WIZ0 + 0x87fe)) "h" "0x0001" 
	...
	echo "++ xcvr_diag_vals ++"                      
	update_register $((BASE_ADDR_WIZ0 + 0x4dcc)) "h" "0x0011" 
	update_register $((BASE_ADDR_WIZ0 + 0x4dce)) "h" "0x0001" 
	update_register $((BASE_ADDR_WIZ0 + 0x4dca)) "h" "0x00c9" 

	echo "++ pcs_cmn_vals ++"                        
	update_register $((BASE_ADDR_WIZ0 + 0xc040)) "h" "0x0a0a" 
	update_register $((BASE_ADDR_WIZ0 + 0xc044)) "h" "0x1000" 
	update_register $((BASE_ADDR_WIZ0 + 0xc046)) "h" "0x0010" 
	...
	update_register $((BASE_ADDR_WIZ0 + 0x0206)) "h" "0x007f"
	update_register $((BASE_ADDR_WIZ0 + 0x0216)) "h" "0x007f"

	echo "++ tx_ln_vals ++"
	update_register $((BASE_ADDR_WIZ0 + 0x4e00)) "h" "0x02ff"
	update_register $((BASE_ADDR_WIZ0 + 0x4e02)) "h" "0x06af"
	update_register $((BASE_ADDR_WIZ0 + 0x4e04)) "h" "0x06ae"
	update_register $((BASE_ADDR_WIZ0 + 0x4e06)) "h" "0x06ae"
	update_register $((BASE_ADDR_WIZ0 + 0x4c80)) "h" "0x2a82"
	update_register $((BASE_ADDR_WIZ0 + 0x4c9a)) "h" "0x0014"
	update_register $((BASE_ADDR_WIZ0 + 0x4dd6)) "h" "0x0003"

	echo "++ rx_ln_vals ++"
	update_register $((BASE_ADDR_WIZ0 + 0x8c00)) "h" "0x0d1d"
	update_register $((BASE_ADDR_WIZ0 + 0x8c02)) "h" "0x0d1d" 
	update_register $((BASE_ADDR_WIZ0 + 0x8c04)) "h" "0x0d00" 
	update_register $((BASE_ADDR_WIZ0 + 0x8c06)) "h" "0x0500" 
	update_register $((BASE_ADDR_WIZ0 + 0x8d20)) "h" "0x0013"
	update_register $((BASE_ADDR_WIZ0 + 0x8e10)) "h" "0x0000"
	update_register $((BASE_ADDR_WIZ0 + 0x8e92)) "h" "0x0c02" 

	update_register $((BASE_ADDR_WIZ0 + 0x8eee)) "h" "0x0330" 
	update_register $((BASE_ADDR_WIZ0 + 0x8ef0)) "h" "0x0300" 
	update_register $((BASE_ADDR_WIZ0 + 0x8ee2)) "h" "0x0019"
	update_register $((BASE_ADDR_WIZ0 + 0x8ee4)) "h" "0x0019"

	update_register $((BASE_ADDR_WIZ0 + 0x8fd0)) "h" "0x1004"
	update_register $((BASE_ADDR_WIZ0 + 0x8fca)) "h" "0x00f9"
	update_register $((BASE_ADDR_WIZ0 + 0x8fc4)) "h" "0x0c01" 
	update_register $((BASE_ADDR_WIZ0 + 0x8fc6)) "h" "0x0002"

	update_register $((BASE_ADDR_WIZ0 + 0x8fea)) "h" "0x0000"
	update_register $((BASE_ADDR_WIZ0 + 0x8fe8)) "h" "0x0031"
	update_register $((BASE_ADDR_WIZ0 + 0x8ffe)) "h" "0x0001"
	update_register $((BASE_ADDR_WIZ0 + 0x8d00)) "h" "0x018c"
	update_register $((BASE_ADDR_WIZ0 + 0x8d04)) "h" "0x0003"
...
exit 0
	...
	update_register $((BASE_ADDR_CTRL_MMR + 0x4074)) "w" "0x0080"
	echo "++ j721e_pcie_set_mode ++"
	update_register $((BASE_ADDR_CTRL_MMR + 0x4074)) "w" "0x0082"
	echo "++ j721e_pcie_set_lane_count ++"
	update_register $((BASE_ADDR_CTRL_MMR + 0x4074)) "w" "0x0182"

	echo "++ j721e_pcie_config_link_irq ++"
	update_register $((BASE_ADDRESS_INTD + 0x108)) "w" "0x0400"

	exit 0
	echo "++ reset ++"
	echo "PHY_RESET_N"
	sleep 0.0001
	update_register $((BASE_ADDR_CFG + 0x08)) "w" "0x0001"
	...
	update_register $((BASE_ADDR_CFG + 0x4)) "w" "0x0000"
	update_register $((BASE_ADDR_CFG + 0x4)) "w" "0x0001"
	...
	update_register $((BASE_ADDR_DBN + 0x200008)) "b" "0x0000"
	update_register $((BASE_ADDR_DBN + 0x200009)) "b" "0x0000"
	update_register $((BASE_ADDR_DBN + 0x20000a)) "h" "0x0604"
	update_register $((BASE_ADDR_DBN + 0x200008))

	echo ""
	echo "++ cdns_pcie_host_init_address_translation  ++"
	update_register $((BASE_ADDR_DBN + 0x400004)) "w" "0x0000"
	update_register $((BASE_ADDR_DBN + 0x40000c)) "w" "0x0000"
	update_register $((BASE_ADDR_DBN + 0x400018)) "w" "0x1800000b"
	update_register $((BASE_ADDR_DBN + 0x40001c)) "w" "0x0000"

	echo ""
	echo "++ cdns_pcie_set_outbound_region ++"
	update_register $((BASE_ADDR_DBN + 0x400020)) "w" "0x0007"
	update_register $((BASE_ADDR_DBN + 0x400024)) "w" "0x0000"
	update_register $((BASE_ADDR_DBN + 0x400028)) "w" "0x800002" 
	update_register $((BASE_ADDR_DBN + 0x40002c)) "w" "0x0000"
	echo ""
	echo "++ Set the PCI address  ++"
	update_register $((BASE_ADDR_DBN + 0x400038)) "w" "0x0007" 
	update_register $((BASE_ADDR_DBN + 0x40003c)) "w" "0x0000"

	echo ""
	echo "++ Set the PCIe header descriptor  ++"
	update_register $((BASE_ADDR_DBN + 0x400040)) "w" "0x1800100f"
	update_register $((BASE_ADDR_DBN + 0x400044)) "w" "0x0000"
	echo ""
	echo "++ Set the CPU address  ++"
	update_register $((BASE_ADDR_DBN + 0x400048)) "w" "0x800006"
	update_register $((BASE_ADDR_DBN + 0x40004c)) "w" "0x0000"
	echo ""
	echo "**********"
	echo "++ cdns_pcie_set_outbound_region  ++"
	update_register $((BASE_ADDR_DBN + 0x400058)) "w" "0x1800100f" 
	update_register $((BASE_ADDR_DBN + 0x40005c)) "w" "0x0000"
	echo ""
	echo "++ Set the PCI address  ++"
	update_register $((BASE_ADDR_DBN + 0x400060)) "w" "0x1801101a"
	update_register $((BASE_ADDR_DBN + 0x400064)) "w" "0x0000"
	echo ""
	echo "++ Set the PCIe header descriptor  ++"
	update_register $((BASE_ADDR_DBN + 0x400068)) "w" "0x800002"
	update_register $((BASE_ADDR_DBN + 0x40006c)) "w" "0x0000"
	echo ""
	echo "++ Set the CPU address  ++"
	update_register $((BASE_ADDR_DBN + 0x400078)) "w" "0x1801101a"
	update_register $((BASE_ADDR_DBN + 0x40007c)) "w" "0x0000"
	echo ""
	echo "++ cdns_pcie_host_bar_ib_config  ++"
	update_register $((BASE_ADDR_DBN + 0x400810)) "w" "0x002f"
	update_register $((BASE_ADDR_DBN + 0x400814)) "w" "0x0000"
	echo "**********"

	echo ""
	echo "++ cdns_ti_pcie_config_write ++"
	update_register $((BASE_ADDR_DBN + 0x004)) "w" "0x0400"
	update_register $((BASE_ADDR_DBN + 0x004)) "w" "0x0000"
	update_register $((BASE_ADDR_DBN + 0x010)) "w" "0xffffffff"
	update_register $((BASE_ADDR_DBN + 0x010)) "w" "0x0000"
	update_register $((BASE_ADDR_DBN + 0x014)) "h" "0xffffffff"
	update_register $((BASE_ADDR_DBN + 0x014)) "h" "0x0000"
	update_register $((BASE_ADDR_DBN + 0x038)) "h" "0xfffff800"
	update_register $((BASE_ADDR_DBN + 0x038)) "h" "0x0000"
	update_register $((BASE_ADDR_DBN + 0x028)) "h" "0xffffffff"
	update_register $((BASE_ADDR_DBN + 0x028)) "h" "0x0000" 
	update_register $((BASE_ADDR_DBN + 0x0e8)) "b" "0x0400" 
	update_register $((BASE_ADDR_DBN + 0x03e)) "b" "0x0002" 
	update_register $((BASE_ADDR_DBN + 0x084)) "b" "0x8008" 
	update_register $((BASE_ADDR_DBN + 0x208)) "b" "0x0000"
	update_register $((BASE_ADDR_DBN + 0x220)) "h" "0x0001"
	update_register $((BASE_ADDR_DBN + 0x224)) "h" "0xffffffff"
	update_register $((BASE_ADDR_DBN + 0x224)) "h" "0x0004"
	update_register $((BASE_ADDR_DBN + 0x228)) "h" "0xffffffff"
	update_register $((BASE_ADDR_DBN + 0x228)) "h" "0x0000"
	update_register $((BASE_ADDR_DBN + 0x22c)) "h" "0xffffffff"
	update_register $((BASE_ADDR_DBN + 0x22c)) "h" "0x0000"
	update_register $((BASE_ADDR_DBN + 0x230)) "h" "0xffffffff"
	update_register $((BASE_ADDR_DBN + 0x230)) "h" "0x0000" 
	update_register $((BASE_ADDR_DBN + 0x234)) "h" "0xffffffff"
	update_register $((BASE_ADDR_DBN + 0x234)) "h" "0x0000"
	update_register $((BASE_ADDR_DBN + 0x238)) "h" "0xffffffff"
	update_register $((BASE_ADDR_DBN + 0x238)) "h" "0x0000"
	update_register $((BASE_ADDR_DBN + 0x210)) "b" "0x0004"
	...
	echo ""
	echo "++ cdns_ti_pcie_config_write ++"
	update_register $((BASE_ADDR_DBN + 0x1a)) "0x1" "b"
	update_register $((BASE_ADDR_DBN + 0x3e)) "0x2" "b"
	update_register $((BASE_ADDR_DBN + 0x224)) "0x18400004" "h"
	update_register $((BASE_ADDR_DBN + 0x228)) "0x0" "h"
	update_register $((BASE_ADDR_DBN + 0x30)) "0xffff" "h"
	update_register $((BASE_ADDR_DBN + 0x1c)) "0xf0" "b"
	update_register $((BASE_ADDR_DBN + 0x30)) "0x0" "h"
	update_register $((BASE_ADDR_DBN + 0x20)) "0xfff0" "h"
	update_register $((BASE_ADDR_DBN + 0x2c)) "0x0" "h"
	update_register $((BASE_ADDR_DBN + 0x24)) "0xfff0" "h"
	update_register $((BASE_ADDR_DBN + 0x28)) "0x0" "w"
	update_register $((BASE_ADDR_DBN + 0x2c)) "0x0" "w"
	update_register $((BASE_ADDR_DBN + 0x3e)) "0x2" "w"
	update_register $((BASE_ADDR_DBN + 0x3c)) "0x0" "w"
	update_register $((BASE_ADDR_DBN + 0xdc)) "0x0" "w" 
	update_register $((BASE_ADDR_DBN + 0x4)) "0x4" "w"
	update_register $((BASE_ADDR_DBN + 0xb2)) "0xc000" "w"
	...
	update_register $((BASE_ADDR_DBN + 0xa0)) "w" "0x0001"
	update_register $((BASE_ADDR_DBN + 0x92)) "w" "0x0180"
	update_register $((BASE_ADDR_DBN + 0x94)) "w" "0x1040000"
	update_register $((BASE_ADDR_DBN + 0x98)) "w" "0x0000"
	update_register $((BASE_ADDR_DBN + 0x9c)) "w" "0x0000"
	...
	update_register $((BASE_ADDR_DBN + 0x00dc)) "w" "0x0000" 
	update_register $((BASE_ADDR_DBN + 0x00e0)) "w" "0x10000"
	update_register $((BASE_ADDR_DBN + 0x00a0)) "w" "0x0000"
	update_register $((BASE_ADDR_DBN + 0x00dc)) "w" "0x0008"
	...
	update_register $((BASE_ADDR_DBN + 0x00dc)) "w" "0x0008"
	update_register $((BASE_ADDR_DBN + 0x0130)) "w" "0x0000"
	update_register $((BASE_ADDR_DBN + 0x0110)) "w" "0x0000"
	update_register $((BASE_ADDR_DBN + 0x0104)) "w" "0x0000"
	update_register $((BASE_ADDR_DBN + 0x012c)) "w" "0x0007"
